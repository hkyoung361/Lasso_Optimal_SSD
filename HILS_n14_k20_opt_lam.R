...
output_folder = "./n14_k20_kstar5_allpos_designs_HILS_lam_opt"
...
for(i in 1:50){write.csv(best_huer[,,i], file = paste("./n14_k20_kstar5_allpos_designs_HILS_lam_opt/best_huer_Var_s_design_", paste(i, ".csv", sep=''), sep=""), row.names = FALSE, col.names=FALSE)}
...
write.csv(prob_results, file ="./n14_k20_kstar5_allpos_designs_HILS_lam_opt/HILS_eval_results.csv", row.names =FALSE, col.names = FALSE)
...
# Save the design
write.csv(HILS_opt, file="./n14_k20_kstar5_allpos_designs_HILS_lam_opt/HILS_opt_n14_k20_kstar5_allpos.csv", row.names = F, col.names=F)
