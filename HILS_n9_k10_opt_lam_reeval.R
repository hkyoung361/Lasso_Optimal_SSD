...
candidate_designs <- as.matrix(read_csv("./n9_k10_kstar3_allsigns_designs_HILS/best_huer_UES_sq_design_1.csv"))

for(i in 2:100){
  if (i<= 50){
    H_1 = as.matrix(read_csv(paste("./n9_k10_kstar3_allsigns_designs_HILS/best_huer_UES_sq_design_", paste(i, ".csv", sep=''), sep="")))
  }
  else{
    H_1 = as.matrix(read_csv(paste("./n9_k10_kstar3_allsigns_designs_HILS/best_huer_Var_s_design_", paste(i-50, ".csv", sep=''), sep="")))
  }
...
write.csv(prob_results, file ="./n9_k10_kstar3_allsigns_designs_HILS/HILS_eval_results_opt_lam.csv", row.names =FALSE, col.names = FALSE)
...
# Save the design
write.csv(HILS_opt, file="./n9_k10_kstar3_allsigns_designs_HILS/HILS_opt_n9_k10_kstar3_allsigns_opt_lam.csv", row.names = F, col.names=F)
